...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Mei 2016 pada 06.02
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
(12, 'Visi', 'hal-visi-misi.html', 3, 0, 'Y'),
(13, 'Sejarah', 'hal-sejarah.html', 3, 0, 'Y'),
(14, 'Form pendafrtaran', 'form-pendaftaran.html', 4, 0, 'Y'),
(15, 'Info PPDB', 'info-ppdb.html', 4, 0, 'Y'),
(16, 'Hasil seleksi', 'hasil-seleksi.html', 4, 0, 'Y'),
(17, 'Berita', 'semua-berita.html', 5, 0, 'Y'),
(18, 'Pengumuman', 'semua-pengumuman.html', 5, 0, 'Y'),
(19, 'Buku tamu', 'bukutamu.html', 7, 0, 'Y'),
(20, 'Hubungi', 'hubungi-kami.html', 7, 0, 'Y');
...
--
ALTER TABLE `hubungi`
MODIFY `id_hubungi` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `pengumuman`
MODIFY `id_pengumuman` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `submenu`
MODIFY `id_sub` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
